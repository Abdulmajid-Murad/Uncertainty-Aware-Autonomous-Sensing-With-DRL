...
def visualize_aq_index():
    ...
    fig.tight_layout()
    fig.savefig('./dataset/plots/aq_index_all_stations.jpg', bbox_inches='tight')
    fig3.tight_layout()
    fig3.savefig('./dataset/plots/right_skewed.jpg', bbox_inches='tight')
...
def visualize_aq():
    ...
    fig.tight_layout()
    fig.savefig('./dataset/plots/aq_data.jpg', bbox_inches='tight')
...
def visualize_weather():
    ...
    for i, col in enumerate(columns):
        ...
        axs[i].set_xlim(xlim)
    fig.tight_layout()
    fig.savefig('./dataset/plots/weather_data.jpg', bbox_inches='tight')
...
def visualize_traffic():
    ...
    for i, col in enumerate(columns):
        ...
        axs[i].set_xlim(xlim)
    fig.tight_layout()
    fig.savefig('./dataset/plots/traffic_data.jpg', bbox_inches='tight')
